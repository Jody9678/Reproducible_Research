...
download.file(fileUrl, destfile = paste0("~/Desktop/RepData2", '/repdata%2Fdata%2FStormData.csv.bz2'))
stormDF <- read.csv("~/Desktop/RepData2/repdata%2Fdata%2FStormData.csv.bz2")
