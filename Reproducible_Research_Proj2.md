...
Github Repo: [Reproducible Research](https://github.com/Jody9678/Reproducible_Research)
</br>

## 1: Synopsis
The goal of the report is to highlight the adverse impact of severe weather events on both population health and the economy, using the NOAA Storm Database as reference. The database covers the time period between 1950 and November 2011.
